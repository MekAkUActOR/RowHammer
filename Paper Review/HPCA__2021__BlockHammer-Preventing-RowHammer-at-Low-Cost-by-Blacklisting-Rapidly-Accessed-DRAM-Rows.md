...
- Both *Graphene* and *BlockHammer* indicate a new direction to prevent RowHammer attacks with zero false negative: use a time-for-space counting algorithm (Misra-Gries algorithm in *Graphene* and Bloom filter in *BlockHammer*) tolerating low false positive to loosely detect potential RowHammer attacks.
...
Since both Misra-Gries algorithm and dual counting Bloom filter can be used as counting-based detection mechanism, 
